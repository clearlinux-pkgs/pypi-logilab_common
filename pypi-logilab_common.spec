...
Source0  : https://files.pythonhosted.org/packages/96/77/735a00a9342602a8ded338f48daad5b10d9b786b9a0d331c9176c70d14ad/logilab-common-1.9.6.tar.gz
...
%prep
%setup -q -n logilab-common-1.9.6
cd %{_builddir}/logilab-common-1.9.6
pushd ..
cp -a logilab-common-1.9.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653342058
...
cp %{_builddir}/logilab-common-1.9.6/COPYING %{buildroot}/usr/share/package-licenses/pypi-logilab_common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.9.6/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pypi-logilab_common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
