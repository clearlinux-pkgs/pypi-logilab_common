...
Source0  : https://files.pythonhosted.org/packages/f6/6e/b77c9177b0c14d6fb2162276036cae0422575a106de0ed11e9fa37131b4d/logilab-common-1.9.5.tar.gz
...
%prep
%setup -q -n logilab-common-1.9.5
cd %{_builddir}/logilab-common-1.9.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651523258
...
cp %{_builddir}/logilab-common-1.9.5/COPYING %{buildroot}/usr/share/package-licenses/pypi-logilab_common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.9.5/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pypi-logilab_common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
