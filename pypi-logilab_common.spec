...
%prep
%setup -q -n logilab-common-1.9.3
cd %{_builddir}/logilab-common-1.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648738529
...
cp %{_builddir}/logilab-common-1.9.3/COPYING %{buildroot}/usr/share/package-licenses/pypi-logilab_common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.9.3/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pypi-logilab_common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
